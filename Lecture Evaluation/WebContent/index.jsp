...
<body>
	...
	<a class="navbar-brand" href="index.jsp">인터넷 강의 리뷰</a>
	...
	<section class="container">
		<form action="./index.jsp" method="get" class="form-inline mt-3">
			...
			<input type="text" name="search" class="form-control mx-1 mt-2" placeholder="검색어를 입력하세요">
	...
	<div class="card bg-light mt-3">
		<div class="card-header bg-light">
			<div class="row">
				<div class="col-8 text-left">JSP강의&nbsp;<small>박건우</small></div>
